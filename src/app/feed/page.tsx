  ...
  return (
    <main className="flex h-[calc(100vh)]  flex-col items-center justify-center p-4 md:px-24 py-32 gap-4">
      <div className="max-w-5xl w-full">
            ...
            <NavigationMenuList className="flex space-x-4">
              ...
              <NavigationMenuItem>
                <Link href="/feed" legacyBehavior passHref>
                  <NavigationMenuLink>post</NavigationMenuLink>
                </Link>
              </NavigationMenuItem>
              <NavigationMenuItem>
        ...
        {/* content */}
        <div
          className="z-10 border lg:columns-3 md:columns-2 sm:columns-2 rounded-lg max-w-5xl text-sm"
          style={{ columnGap: "20px", padding: "20px" }}
        >
          {" "}
          {/* Added padding here */}
          <Card className="w-full md:w-[calc(50% - 20px)] lg:w-[calc(33.333% - 20px)] mb-5 break-inside-avoid">
            <CardHeader>
