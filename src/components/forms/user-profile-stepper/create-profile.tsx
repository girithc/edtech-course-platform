...
export const CreateProfileOne: React.FC<ProfileFormType> = ({
  ...
  const title = initialData ? "Edit product" : " profile";
  const description = initialData ? "Edit a product." : "beta feature";
  ...
  const countries = [{ id: "wow", name: "usa" }];
  const cities = [{ id: "2", name: "california" }];
